export type InferenceMode = 'explore_node' | 'generate_with_bfs' | 'generate_with_smc';
export type ModelControlMode = 'load_model' | 'check_model_status';
...
export interface ModelControlRequest {
  type: ModelControlMode;
  request_id?: string;
}

export type WebSocketRequest = InferenceRequest | ModelControlRequest;
...
export interface WebSocketState {
  ...
  messages: Array<{
    ...
    timestamp: number;
    data: WebSocketRequest | WebSocketResponse;
  }>;
}
...
export interface VisualNode {
  ...
  userFoldedSiblingCount?: number;
  isFiltered?: boolean;
  overviewDepthPrunedHasBadDescendant?: boolean;
